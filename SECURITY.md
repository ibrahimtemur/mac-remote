...
2. **Network Boundaries:**
   ...
   - **Remote Internet Access (Ngrok):** When enabled, traffic is encrypted via HTTPS / WSS through Ngrok's secure TLS endpoints. Never share your public tunnel URL or auth token with untrusted parties.
